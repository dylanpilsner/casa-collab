    ...
    <div id="features">
      <Slide triggerOnce>
        ...
        <Feature src="/tasks-assign.png" title="Asignación de tareas">
          ...
          miembro del hogar esté involucrado y comprometido con la organización
          diaria. Simplifica la coordinación y mejora la productividad en tu
          hogar con nuestra intuitiva función de asignación de tareas.
        </Feature>
        ...
        >
          ...
          Nuestra interfaz intuitiva te permite ver rápidamente qué tareas están
          completas, cuáles están en proceso y cuáles necesitan atención
        ...
        <Feature src="/finance.png" title="Registro de gastos compartido">
          ...
          categorízalos para tener una visión clara de dónde se está gastando el
          dinero, evitando sorpresas desagradables y promoviendo una
